...
import { COLORS, ICONS, buildEmbed, errorMsg } from "../utils/theme.js";
...
export const setupChannel: Command = {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const embed = buildEmbed({
            ...
            description: [`${ICONS.channel} O canal de relatórios da guilda **${project.name}** foi definido para <#${channel.id}>`, "", `${ICONS.arrow} Os diários de expedição serão postados lá a partir de agora.`, `${ICONS.sparkle} *Que as aventuras comecem!*`].join("\n"),
